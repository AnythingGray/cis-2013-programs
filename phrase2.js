...
var vowels = function () 
{
    ...
    if (stringEntry === "")
    {
        alert("Please enter a phrase and then select the button");
    }
    else
    {
        var intVowels = 0;
        ...
        {
            if(stringEntry.charAt(intCount) === "A" || stringEntry.charAt(intCount) === "I" || stringEntry.charAt(intCount) === "E" || stringEntry.charAt(intCount) === "I" || stringEntry.charAt(intCount) === "O" || stringEntry.charAt(intCount) === "U")
            {
                intVowels++; 
            }
        }
